  ...
  <div>
    <div class="page-header signup-page section-image">
      <div
        ...
        style="background-image: url(&quot;img/nuaa/zhulou-3.jpeg&quot;);"
      ></div>
      <div class="content">
        <div class="container">
          <div class="row">
      ...
      <footer class="footer">
        <div class="container">
          <nav>
            <ul>
              <li>
                <a href="https://wyjoutstanding.github.io/">About Me</a>
              </li>
              <li>
                <a href="https://wyjoutstanding.github.io/">Blog</a>
              </li>
            </ul>
          </nav>
          <div class="copyright">
            © 2019, Designed by
            <a
              href="https://wyjoutstanding.github.io/"
              rel="noopener"
              target="_blank"
            >wuyangjun</a>. Coded by
            <a
              href="https://wyjoutstanding.github.io/"
              rel="noopener"
              target="_blank"
      ...
      login(this.loginForm.accountName, this.loginForm.accountPassword) // 调用后端api
        .then(response => {
          ...
          if (response.data.code == 304) {
            ...
            if (user.accountType === "TEACHER") this.$router.push({ path: "/layout" }); // 登录成功，跳转教师页面
            else this.$router.push({ path: "/layoutStu" }); // 学生页面
