    ...
    <div class="flex1">
        ...
        <el-header class="col-sm-24">
            ...
            active-text-color="#ffd04b">
                <!-- <el-menu-item index="5"  class="fr"><a href="/Profile"><i class="el-icon-user"/>个人中心</a></el-menu-item> -->
                ...
                <el-menu-item index="4"><a href="/Baidu" target="_blank">百度一下</a></el-menu-item>
                <el-submenu index="2" class="fr">
        ...
        <el-container>
          ...
          <el-menu
            ...
            <el-submenu index="4">
              ...
              <el-menu-item-group>
                <el-menu-item index="4-1">上传资源</el-menu-item>
                <el-menu-item index="4-2">查询资源</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
