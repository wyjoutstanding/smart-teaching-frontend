      ...
      <el-header class="col-sm-24">
        ...
        >
          ...
          <el-submenu index="2" class="fr">
            ...
            <el-menu-item index="2-1" @click="$router.push({path:'/PersonInfoStu'})">基本信息</el-menu-item>
            ...
            >
              ...
              <el-menu-item index="1">
                <template slot="title">
                  ...
                  <span @click="$router.push({path:'/ClassesStu'})">我的班级</span>
                </template>
                <!-- <el-menu-item-group>
                                    <el-menu-item index="3-1">提交作业</el-menu-item>
                                    <el-menu-item index="3-2">查看得分</el-menu-item>
                </el-menu-item-group>-->
                <!-- </el-submenu> -->
              </el-menu-item>
              <!-- <el-submenu index="1">
                                ...
                                <el-menu-item-group>
                                    <el-menu-item index="1-1" @click="formClass.dialogFormVisible=true">加入班级</el-menu-item>
                                    <el-menu-item index="1-2" @click="$router.push({path:'/ClassesStu'})">查看班级</el-menu-item>
                                </el-menu-item-group>
              </el-submenu>-->
              <!-- 题库管理 -->
              <el-submenu index="2">
                ...
                <el-menu-item-group>
                  ...
                  <el-menu-item index="2-2">我的错题</el-menu-item>
                  <el-menu-item index="2-3">随机刷题</el-menu-item>
                </el-menu-item-group>
              </el-submenu>
              <!-- 作业管理 -->
              <!-- <el-submenu index="3"> -->
              <el-menu-item index="3">
                <template slot="title">
                  <i class="el-icon-document"></i>
                  <span @click="$router.push({path:'/HomeworkStu'})">作业管理</span>
                </template>
                <!-- <el-menu-item-group>
                                    <el-menu-item index="3-1">提交作业</el-menu-item>
                                    <el-menu-item index="3-2">查看得分</el-menu-item>
              ...
              <el-submenu index="4">
                ...
                <el-menu-item-group>
                  <el-menu-item index="4-1" @click="$router.push({path:'/UploadStu'})">上传资源</el-menu-item>
                  <el-menu-item index="4-2" @click="$router.push({path:'/ResourceStu'})">查询资源</el-menu-item>
                </el-menu-item-group>
              </el-submenu>
...
export default {
  ...
  methods: {
    ...
    gotoClass() {
      // alert('h13')
      this.$router.push({ path: "/ClassesStu" });
    },
    // 修改密码
    handleEditPassword() {
      ...
      createClass(this.formClass.className, this.formClass.classType)
        .then(res => {
          if (res.data.code == 337) {
            ...
            this.$router.push({
              path: "/ClassesStu",
              component: resolve => require(["../pages/ClassesStu"], resolve)
            }); // 重定向为班级界面
            this.reload(); // 重新加载
          }
        })
